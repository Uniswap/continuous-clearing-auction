...
| -------- | ------------------------------------------ | ---------------------------------------- | ---------------- |
| v2.1.0   | 0x000000001F26a0044BaA66024e7b6599c61963F8 | 7d7602d257733315434570f2a0c2f94f1c7b207a | v2.1.0           |
...
> \*v2.1.0 is the latest version of CCA and is the recommended version for production use. It is equivalent to v2.0.0 but includes a bug fix for Arbitrum and Orbit chains. For more details, see the [Changelog](./CHANGELOG.md).
