# AuctionFactory
[Git Source](https://github.com/Uniswap/twap-auction/blob/d8923ff869bd7fcb722e5bcf182d5585489c9701/src/AuctionFactory.sol)
...
## State Variables
### USE_MSG_SENDER
Sentinel value to use for msg.sender
