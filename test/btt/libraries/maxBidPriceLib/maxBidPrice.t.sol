...
contract MaxBidPriceLibTest is Test {
    function test_WhenTotalSupplyIsLELowerTotalSupplyThreshold_ThenMaxBidPriceIsMaxV4Price(uint128 _totalSupply) public {
    ...
    function test_WhenTotalSupplyIsGTLowerTotalSupplyThreshold(uint128 _totalSupply) public {
        ...
        _totalSupply = uint128(bound(_totalSupply, MaxBidPriceLib.LOWER_TOTAL_SUPPLY_THRESHOLD + 1, ConstantsLib.MAX_TOTAL_SUPPLY));
        uint256 maxBidPrice = MaxBidPriceLib.maxBidPrice(_totalSupply);
