...
async function testSimple() {
  console.log('Testing simple auction creation...');
  ...
  // Try to create SimpleAuction directly
  console.log('Creating SimpleAuction directly...');
  try {
    ...
    console.log('SimpleAuction created successfully!');
    console.log('Auction address:', await auction.getAddress());
  } catch (error) {
    console.error('SimpleAuction creation failed:', error.message);
